...
The famous game with an updatable option list (project from JB Academy)
...
After entering his/her name, the user should provide a list of options separated by a comma. 
...
to determine which options are stronger or weaker than the option you're currently looking at? Well, you can try to do it this way: 
...
Your program should:
    ...
    - If the input is the name of the option, then: Pick a random option
